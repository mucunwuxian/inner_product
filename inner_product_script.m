...
time = toc;
fprintf('vector’·:%d, matlab        ‚Å‚Ì“àÏŒvZŠÔ:%f\n', size(w, 1), time);
...
time = toc;
fprintf('vector’·:%d, mex           ‚Å‚Ì“àÏŒvZŠÔ:%f\n', size(w, 1), time);
...
time = toc;
fprintf('vector’·:%d, mex+openmp    ‚Å‚Ì“àÏŒvZŠÔ:%f\n', size(w, 1), time);
...
time = toc;
fprintf('vector’·:%d, mex+openmp+sse‚Å‚Ì“àÏŒvZŠÔ:%f\n', size(w, 1), time);
...
time = toc;
fprintf('vector’·:%d, mex+openmp+avx‚Å‚Ì“àÏŒvZŠÔ:%f\n', size(w, 1), time);
